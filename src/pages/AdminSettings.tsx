...
export default function AdminSettings() {
  ...
  const tabs = [
    ...
    { key: 'auth', label: 'Đổi mật khẩu', icon: 'lock' },
  ];

  if (loading) {
    return (
      <div className="p-10 text-center text-on-surface-variant font-semibold">Đang tải...</div>
    );
  }

  return (
    <div className="p-8 max-w-3xl">
      <h1 className="text-2xl font-black text-on-surface mb-1">Cài đặt tài khoản</h1>
      <p className="text-sm text-on-surface-variant mb-8">Quản lý thông tin cá nhân và bảo mật</p>
      ...
      {activeTab === 'profile' && (
        <div className="max-w-xl">
          <div className="flex items-center gap-5 mb-8 p-5 bg-surface-container rounded-2xl">
            <img
          ...
          <form onSubmit={handleProfileSave} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-outline-variant/30 bg-surface-container-lowest px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
