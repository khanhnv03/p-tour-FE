  ...
  return (
    <div className="flex min-h-screen bg-surface">
      ...
      <main className="flex-1 ml-64 min-h-screen relative flex flex-col">
        ...
        {/* Footer */}
        <footer className="mt-auto bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-8 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <span className="text-xl font-bold text-blue-900 dark:text-blue-100">{BRAND_NAME}</span>
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-widest text-slate-900 dark:text-white mb-4">Pháp lý</h4>
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-widest text-slate-900 dark:text-white mb-4">Hỗ trợ</h4>
              <div className="space-y-2">
