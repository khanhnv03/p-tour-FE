...
export default function UserLayout() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col font-sans">
      {/* TopNavBar */}
      <nav className="bg-white/90 backdrop-blur-xl top-0 sticky z-50 shadow-[0_8px_32px_0_rgba(25,28,29,0.06)]">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto font-medium tracking-tight">
          <Link to="/" className="flex items-center gap-3 group">
            <img src={BRAND_LOGO} alt="PTIT Logo" className="h-10 w-auto transition-transform duration-300 group-hover:scale-110" />
            <div className="text-xl font-black tracking-tighter text-blue-900 transition-opacity duration-200 group-hover:opacity-75">
              {BRAND_NAME}
            </div>
          </Link>
      ...
      <div className="max-w-7xl mx-auto w-full px-8 py-10 flex flex-col lg:flex-row gap-12 flex-grow">
        ...
        <aside className="hidden lg:flex flex-col w-64 shrink-0 self-start sticky top-[100px] space-y-6">
          <div className="bg-surface-container-lowest rounded-3xl p-6 border border-surface-container-low shadow-[0_8px_32px_0_rgba(25,28,29,0.04)] text-center relative overflow-hidden group">
            <div className="absolute inset-0 signature-gradient opacity-10 group-hover:opacity-20 transition-opacity" />
            ...
            <div className="relative z-10">
              <h3 className="text-blue-900 font-black text-lg truncate">{displayName}</h3>
      ...
      {/* Footer */}
      <footer className="bg-slate-50 w-full mt-auto text-sm leading-relaxed border-t border-slate-200">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 py-16 max-w-7xl mx-auto">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-500 max-w-xs">Kiến tạo những trải nghiệm vượt xa tầm thường. Mỗi hành trình đều được tuyển chọn, mỗi khoảnh khắc là của riêng bạn.</p>
          </div>
          <div>
            <h4 className="font-black text-blue-900 mb-6 uppercase tracking-widest text-xs">Khám phá</h4>
          ...
          <div>
            <h4 className="font-black text-blue-900 mb-6 uppercase tracking-widest text-xs">Hỗ trợ</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-black text-blue-900 mb-6 uppercase tracking-widest text-xs">Kết nối</h4>
